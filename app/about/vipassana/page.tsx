		...
		<SimplePageLayout title="ヴィパッサナー瞑想">
			...
			<ContentCard>
				...
				<div className="mt-4 prose prose-sm max-w-none prose-slate">
					<p>
						ヴィパッサナーの実践法は、とてもシンプルです。ただ、今の自分に気づく。そこに、深遠な世界が広がってくるのです。パーリ語でvi
						ヴィとは「ありのままに・明瞭に・客観的に」、passanā
						パッサナーとは「観察する・観る・心の目で見る」という意味です。「今この瞬間の自分自身をよく観る」ということです。瞬間瞬間に起こる、思い込みやしがらみを理解できるvipassanā
						ヴィパッサナーは、「気づきの瞑想」や「洞察の瞑想」ともいえるでしょう。
					</p>
					<p>
