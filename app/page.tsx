import TalkGallery from "./components/TalkGallery";

const SHEET_URL =
  "https://docs.google.com/spreadsheets/d/1QMyakqH1i-W_bbK3yJl7u_Q_Jb_AoM94W6F8Gg3y3CA/export?format=csv&gid=672351880";
...
function parseCSVToTalks(text: string): Talk[] {
  ...
  for (let i = 1; i < lines.length; i += 1) {
    ...
    const talk: Talk = {
      ...
      folder: getValue(cells, "Dropboxフォルダー名"),
      event,
      ...
      format: getValue(cells, "音声フォーマット"),
      audioLink: sanitizeLink(getValue(cells, "リンク")),
      attachmentsLink: sanitizeLink(
        getValue(cells, "添付データ（スライド、サマリー等）"),
      ),
    };
