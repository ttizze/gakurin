			...
			<div className="relative mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
				...
				<div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
					<div className="max-w-2xl">
						<h1 className="text-4xl font-semibold leading-tight text-slate-800 dark:text-slate-100 sm:text-5xl">
							初期仏教塾
						</h1>
					...
					<div className="flex flex-col gap-1.5 rounded border border-slate-300/70 bg-slate-100/80 px-3 py-2 text-xs text-slate-600 backdrop-blur-sm dark:border-slate-600/70 dark:bg-slate-800/80 dark:text-slate-300 sm:text-sm">
